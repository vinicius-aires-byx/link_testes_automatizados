Cypress.Commands.add('analise_com_sucesso', project => {
  cy.request({
    method: 'POST',
...
Cypress.Commands.add('portal_transparencia_com_sucesso', project => {
    cy.request({
      method: 'POST',
      url: `/analise-contrato/`,
      body: {
...
Cypress.Commands.add('banco_permitido_reprovado', project => {
    cy.request({
      method: 'POST',
      url: `/analise-contrato/`,
      body: {
...
Cypress.Commands.add('valor_minimo_parcela_reprovado', project => {
    cy.request({
      method: 'POST',
      url: `/analise-contrato/`,
      body: {
...
Cypress.Commands.add('numero_total_parcelas_reprovado', project => {
    cy.request({
      method: 'POST',
      url: `/analise-contrato/`,
      body: {
...
Cypress.Commands.add('data_emissao_rg_reprovado', project => {
    cy.request({
      method: 'POST',
      url: `/analise-contrato/`,
      body: {
...
Cypress.Commands.add('idade_maxima_reprovado', project => {
    cy.request({
      method: 'POST',
      url: `/analise-contrato/`,
      body: {
...
Cypress.Commands.add('idade_minima_reprovado', project => {
    cy.request({
      method: 'POST',
      url: `/analise-contrato/`,
      body: {
...
Cypress.Commands.add('valor_minimo_contrato_reprovado', project => {
    cy.request({
      method: 'POST',
      url: `/analise-contrato/`,
      body: {
