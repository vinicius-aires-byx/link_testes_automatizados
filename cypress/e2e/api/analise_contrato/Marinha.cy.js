describe('Analise de contrato - Sucesso', () => {
  it('successfully', () => {
    cy.analise_com_sucesso_marinha()
      .then(response => {
        ...
        expect(regras.regra_aprovada).to.be.true
        regras = response.body.regras.find(m => m.descricao === "Valor Mínimo CCB: R$ 700,00;")
        expect(regras.regra_aprovada).to.be.true
        regras = response.body.regras.find(m => m.descricao === "Valor Máximo CCB: R$ 20.000,00;")
        expect(regras.regra_aprovada).to.be.true
        regras = response.body.regras.find(m => m.descricao === "Banco em lista;")
        expect(regras.regra_aprovada).to.be.true
        regras = response.body.regras.find(m => m.descricao === "CPF em lista;")
        expect(regras.regra_aprovada).to.be.true
        regras = response.body.regras.find(m => m.descricao === "Cidade em lista;")
        expect(regras.regra_aprovada).to.be.true
        regras = response.body.regras.find(m => m.descricao === "Número Total de Parcelas;")
        expect(regras.regra_aprovada).to.be.true
        regras = response.body.regras.find(m => m.descricao === "Janela Primeira Parcelas: 30 dias;")
        expect(regras.regra_aprovada).to.be.true
        ...
        expect(regras.regra_aprovada).to.be.true
        regras = response.body.regras.find(m => m.descricao === "Carencia primeiro vencimento: 60 dias")
        expect(regras.regra_aprovada).to.be.true
        ...
        expect(regras.regra_aprovada).to.be.true
        regras = response.body.regras.find(m => m.descricao === "Taxa Maxima: 1.95;")
        expect(regras.regra_aprovada).to.be.true
        ...
        expect(regras.regra_aprovada).to.be.true
        regras = response.body.regras.find(m => m.descricao === "Dia de vencimento dentro do range definido;")
        expect(regras.regra_aprovada).to.be.true
        ...
        expect(regras.regra_aprovada).to.be.true
        regras = response.body.regras.find(m => m.descricao === "Validar beneficio - Forças Armadas")
        expect(regras.regra_aprovada).to.be.true
        regras = response.body.regras.find(m => m.descricao === "Validar Patente;")
        expect(regras.regra_aprovada).to.be.true
...
describe("Teste reprovação das regras", () => {
  ...
  let regraEncontrada
  beforeEach(() => {
    cy.fixture("marinha_bodyBase.json").then((data) => { body = data })
  })
  it("Limite Mínimo Idade: 21 anos; REPROVADO", () => {
    body.cliente.dtNascimento = "2010-05-07"
    cy.request({
      method: "POST",
      ...
      expect(response.status).to.equal(201)
      regraEncontrada = response.body.regras.find(m => m.descricao === "Limite Mínimo Idade: 21 Anos;");
      expect(regraEncontrada.regra_aprovada).to.be.false;
    })
  })
  it("Limite Máximo Idade: 73 Anos; REPROVADO", () => {
    ...
    cy.request({
      ...
      expect(response.status).to.equal(201)
      regraEncontrada = response.body.regras.find(m => m.descricao === "Idade Maxima: 73 anos;");
      expect(regraEncontrada.regra_aprovada).to.be.false;
    })
  })
  it("Data de emissão do documento x Data de nascimento; REPROVADO", () => {
    ...
    cy.request({
      ...
      expect(response.status).to.equal(201)
      regraEncontrada = response.body.regras.find(m => m.descricao === "Data de emissao do documento x Data de nascimento;");
      expect(regraEncontrada.regra_aprovada).to.be.false;
    })
  })
  it("Valor Mínimo CCB: R$ 700,00; REPROVADO", () => {
    ...
    cy.request({
      ...
      expect(response.status).to.equal(201)
      regraEncontrada = response.body.regras.find(m => m.descricao === "Valor Mínimo CCB: R$ 700,00;");
      expect(regraEncontrada.regra_aprovada).to.be.false;
    })
  })
  ...
  it("Banco em lista; REPROVADO", () => {
    ...
    cy.request({
      ...
      expect(response.status).to.equal(201)
      regraEncontrada = response.body.regras.find(m => m.descricao === "Banco em lista;");
      expect(regraEncontrada.regra_aprovada).to.be.false;
    })
  })
  it("CPF em lista; REPROVADO", () => {
    body.cliente.nuCpf = "03226995201"
    cy.request({
      method: "POST",
      url: `/analise-contrato/`,
      body: body,
      ...
      expect(response.status).to.equal(201)
      regraEncontrada = response.body.regras.find(m => m.descricao === "CPF em lista;");
      expect(regraEncontrada.regra_aprovada).to.be.false;
    })
  })
  it("Cidade em lista; REPROVADO", () => {
    ...
    cy.request({
      ...
      expect(response.status).to.equal(201)
      regraEncontrada = response.body.regras.find(m => m.descricao === "Cidade em lista;");
      expect(regraEncontrada.regra_aprovada).to.be.false;
    })
  })
  ...
  it("Janela Primeira Parcelas: 30 dias; REPROVADO", () => {
    ...
    body.parcela[9].dtVencimento = dataFormatada
    cy.request({
      method: "POST",
      url: `/analise-contrato/`,
      body: body,
      ...
      expect(response.status).to.equal(201)
      regraEncontrada = response.body.regras.find(m => m.descricao === "Janela Primeira Parcelas: 30 dias;");
      expect(regraEncontrada.regra_aprovada).to.be.false;
    })
  })
  it("Valor Mínimo de Parcela: R$ 30,00; REPROVADO", () => {
    body.parcela[9].vrParcela = "10.00"
    cy.request({
      method: "POST",
      url: `/analise-contrato/`,
      body: body,
  ...
  it("Inadimplência Parcela/Contrato; REPROVADO", () => {
    body.parcela[9].dtVencimento = "2024-11-11"
    cy.request({
      method: "POST",
      url: `/analise-contrato/`,
      body: body,
  ...
  it("Contrato Liquidado; REPROVADO", () => {
    cy.fixture("marinha_bodyLiquidado").then((bodyLiquidado) => {
      cy.request({
        method: "POST",
        url: `/analise-contrato/`,
  ...
  it("Número Mínimo de Parcelas: 10; REPROVADO", () => {
    cy.fixture("marinha_bodyQuantMinParc").then((bodyQuantMinParc) => {
      cy.request({
        method: "POST",
        url: `/analise-contrato/`,
        ...
        expect(response.status).to.equal(201)
        regraEncontrada = response.body.regras.find(m => m.descricao === "Numero Minimo Parcelas: 10;");
        expect(regraEncontrada.regra_aprovada).to.be.false;
      })
    })
  })
  it("Número Máximo de Parcelas: 12; REPROVADO", () => {
    cy.fixture("marinha_bodyQuantMaxParc").then((bodyQuantMaxParc) => {
      cy.request({
        method: "POST",
        url: `/analise-contrato/`,
        ...
        expect(response.status).to.equal(201)
        regraEncontrada = response.body.regras.find(m => m.descricao === "Numero Maximo Parcelas: 12;");
        expect(regraEncontrada.regra_aprovada).to.be.false;
      })
    })
  })
  it("Validar carencia primeiro vencimento: 60 dias; REPROVADO", () => {
    ...
    cy.request({
      ...
      expect(response.status).to.equal(201)
      regraEncontrada = response.body.regras.find(m => m.descricao === "Carencia primeiro vencimento: 60 dias");
      expect(regraEncontrada.regra_aprovada).to.be.false;
    })
  })
  ...
  it("Taxa Minima: 1.20; REPROVADO", () => {
    body.contrato.txEfetivaMes = "0.00017"
    cy.request({
      method: "POST",
      url: `/analise-contrato/`,
      body: body,
      ...
      expect(response.status).to.equal(201)
      regraEncontrada = response.body.regras.find(m => m.descricao === "Taxa Minima: 1.20;");
      expect(regraEncontrada.regra_aprovada).to.be.false;
    })
  })
  it("Taxa Maxima: 1.95; REPROVADO", () => {
    ...
    cy.request({
      ...
      expect(response.status).to.equal(201)
      regraEncontrada = response.body.regras.find(m => m.descricao === "Taxa Maxima: 1.95;");
      expect(regraEncontrada.regra_aprovada).to.be.false;
    })
  })
  ...
  it("Dia de vencimento fora do range definido; REPROVADO", () => {
    ...
    cy.request({
      ...
      expect(response.status).to.equal(201)
      regraEncontrada = response.body.regras.find(m => m.descricao === "Dia de vencimento dentro do range definido;");
      expect(regraEncontrada.regra_aprovada).to.be.false;
    })
  })
  ...
  it("Validar beneficio forças armadas; REPROVADO", () => {
    body.beneficio.matricula = "19"
    cy.request({
      method: "POST",
      url: `/analise-contrato/`,
      body: body,
      ...
      expect(response.status).to.equal(201)
      regraEncontrada = response.body.regras.find(m => m.descricao === "Validar beneficio - Forças Armadas");
      expect(regraEncontrada.regra_aprovada).to.be.false;
    })
  })
  it("Validar patente; REPROVADO", () => {
    body.cliente.empresa.nmCargo = "CMG"
    cy.request({
      method: "POST",
      url: `/analise-contrato/`,
      body: body,
      ...
      expect(response.status).to.equal(201)
      regraEncontrada = response.body.regras.find(m => m.descricao === "Validar Patente;");
      expect(regraEncontrada.regra_aprovada).to.be.false;
    })
  })
  it("Validar beneficio X idade; REPROVADO", () => {
    body.cliente.dtNasicmento = "2001-10-21"
    body.parcela[11].dtVencimento = "2030-10-12"
    cy.request({
      method: "POST",
      url: `/analise-contrato/`,
      body: body,
  ...
  it("Validar Data Primeiro Vencimento superior Data contrato; REPROVADO", () => {
    body.contrato.dtPrimeiroVencimento = "2021-01-31"
    cy.request({
      method: "POST",
      url: `/analise-contrato/`,
      body: body,
  ...
  it("Mínimo de Parcelas Pagas; REPROVADO", () => {
    cy.fixture("marinha_bodyMinParcelasPagas").then((bodyMinParc) => {
      cy.request({
        method: "POST",
        url: `/analise-contrato/`,
  ...
  it("Máximo de parcelas pagas; REPROVADO", () => {
    cy.fixture("marinha_bodyMaxParcelasPagas").then((bodyMaxParc) => {
      cy.request({
        method: "POST",
        url: `/analise-contrato/`,
  ...
  it("Validar DEC (Data de Encerramento de Cota); REPROVADO", () => {
    body.parcela[11].dtVencimento = "2025-07-20"
    cy.request({
      method: "POST",
      url: `/analise-contrato/`,
      body: body,
