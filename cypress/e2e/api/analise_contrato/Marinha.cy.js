  ...
  it('successfully', () => {
    cy.analise_com_sucesso_marinha()
      .then(response => {
        ...
        let regras = response.body.regras.find(m => m.descricao === "Idade Maxima: 73 anos;")
...
describe('Idade Maxima: 73 anos; REPROVADO', () => {
  it('successfully', () => {
    cy.idade_maxima_reprovado_marinha()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Parcela Minima; REPROVADO', () => {
  it('successfully', () => {
    cy.parcela_minima_reprovado_marinha()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Taxa Minima: 1.20; REPROVADO', () => {
  it('successfully', () => {
    cy.taxa_minima_reprovado_marinha()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Taxa Maxima: 1.95; REPROVADO', () => {
  it('successfully', () => {
    cy.taxa_maxima_reprovado_marinha()
      .then(response => {
        expect(response.status).to.equal(201)
        let regraEncontrada = response.body.regras.find(m => m.descricao === "Taxa Maxima: 1.95;");
        expect(regraEncontrada.regra_aprovada).to.be.false;
      })
  })
})
...
describe('Valor Minimo Contrato: R$ 250.00; REPROVADO', () => {
  it('successfully', () => {
    cy.valor_minimo_contrato_reprovado_marinha()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Valor Maximo Contrato: R$ 20000.00 REPROVADO', () => {
  it('successfully', () => {
    cy.valor_maximo_contrato_reprovado_marinha()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Data de emissao do documento x Data de nascimento; REPROVADO', () => {
  it('successfully', () => {
    cy.data_emissao_documento_x_data_nascimento_reprovado_marinha()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Contrato Liquidado; REPROVADO', () => {
  it('successfully', () => {
    cy.contrato_liquidado_reprovado_marinha()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Inadimplência Parcela/Contrato; REPROVADO', () => {
  it('successfully', () => {
    cy.inadimplencia_parcela_contrato_reprovado_marinha()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Numero Total de Parcelas; REPROVADO', () => {
  it('successfully', () => {
    cy.numero_total_parcelas_reprovado_marinha()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Numero Maximo Parcelas: 12; REPROVADO', () => {
  it('successfully', () => {
    cy.numero_maximo_parcelas_reprovado_marinha()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Numero Minimo Parcelas: 10; REPROVADO', () => {
  it('successfully', () => {
    cy.numero_minimo_parcelas_reprovado_marinha()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Range data vencimento; REPROVADO', () => {
  it('successfully', () => {
    cy.range_data_vencimento_reprovado_marinha()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Patente; REPROVADO', () => {
  it('successfully', () => {
    cy.patente_reprovado_marinha()
      .then(response => {
        expect(response.status).to.equal(201)
        let regraEncontrada = response.body.regras.find(m => m.descricao === "Patente;");
        expect(regraEncontrada.regra_aprovada).to.be.false;
      })
  })
})
