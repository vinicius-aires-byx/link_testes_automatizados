  ...
  it("successfully", () => {
    cy.analise_com_sucesso_inss()
      .then(response => {
        ...
        expect(regras.regra_aprovada).to.be.true
        regras = response.body.regras.find(m => m.descricao === "Data de emissão do RG x Data de nascimento;")
        expect(regras.regra_aprovada).to.be.true
...
describe("Teste reprovação das regras", () => {
  ...
  let regraEncontrada
  beforeEach(() => {
    cy.fixture("inss_bodyBase.json").then((data) => { body = data })
  })
  ...
  it("Data de emissão do documento x Data de nascimento; REPROVADO", () => {
    ...
    cy.request({
      ...
      expect(response.status).to.equal(201)
      regraEncontrada = response.body.regras.find(m => m.descricao === "Data de emissão do RG x Data de nascimento;");
      expect(regraEncontrada.regra_aprovada).to.be.false;
    })
  })
  ...
  it("Blacklist CPFs; REPROVADO", () => {
    body.cliente.nuCpf = "174326589317"
    cy.request({
      method: "POST",
      url: `/analise-contrato/`,
      body: body,
  ...
  it("Janela Primeira Parcelas: 25 dias; REPROVADO", () => {
    ...
    body.parcela[6].dtVencimento = dataFormatada
    cy.request({
      method: "POST",
      url: `/analise-contrato/`,
      body: body,
  ...
  it("Valor Mínimo de Parcela: R$ 30,00; REPROVADO", () => {
    body.parcela[6].vrParcela = "10.00"
    cy.request({
      method: "POST",
      url: `/analise-contrato/`,
      body: body,
  ...
  it("Contrato Liquidado; REPROVADO", () => {
    cy.fixture("inss_bodyLiquidado").then((bodyLiquidado) => {
      cy.request({
        method: "POST",
        url: `/analise-contrato/`,
  ...
  it("Número Mínimo de Parcelas: 10; REPROVADO", () => {
    cy.fixture("inss_bodyQuantMinParc").then((bodyQuantMinParc) => {
      cy.request({
        method: "POST",
        url: `/analise-contrato/`,
  ...
  it("Número Máximo de Parcelas: 12; REPROVADO", () => {
    cy.fixture("inss_bodyQuantMaxParc").then((bodyQuantMaxParc) => {
      cy.request({
        method: "POST",
        url: `/analise-contrato/`,
  ...
  it("Validar Data Primeiro Vencimento superior Data contrato; REPROVADO", () => {
    body.contrato.dtPrimeiroVencimento = "2024-01-31"
    cy.request({
      method: "POST",
      url: `/analise-contrato/`,
      body: body,
  ...
  it("Mínimo de Parcelas Pagas; REPROVADO", () => {
    cy.fixture("inss_bodyMinParcelasPagas").then((bodyMinParc) => {
      cy.request({
        method: "POST",
        url: `/analise-contrato/`,
  ...
  it("Máximo de parcelas pagas; REPROVADO", () => {
    cy.fixture("inss_bodyMaxParcelasPagas").then((bodyMaxParc) => {
      cy.request({
        method: "POST",
        url: `/analise-contrato/`,
