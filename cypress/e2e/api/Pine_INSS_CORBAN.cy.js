...
describe('Analise com sucesso', () => {
  ...
  it('successfully', () => {
    ...
    cy.analise_com_sucesso_pine_inss_corban()
      .then(response => {
...
describe('Portal da transparência com sucesso', () => {
  ...
  it('successfully', () => {
    ...
    cy.portal_transparencia_com_sucesso_pine_inss_corban()
      .then(response => {
        expect(response.status).to.equal(201)
        expect(response.body.regras[0].descricao).to.equal(project.description0)
        expect(response.body.regras[0].regra_aprovada).to.equal(true)
...
describe('banco permitido REPROVADO', () => {
  ...
  it('successfully', () => {
    ...
    cy.banco_permitido_reprovado_pine_inss_corban()
      .then(response => {
        expect(response.status).to.equal(201)
        expect(response.body.regras[0].descricao).to.equal(project.description0)
        expect(response.body.regras[0].regra_aprovada).to.equal(true)
...
describe('valor mínimo da parcela REPROVADO', () => {
  ...
  it('successfully', () => {
    ...
    cy.valor_minimo_parcela_reprovado_pine_inss_corban()
      .then(response => {
        expect(response.status).to.equal(201)
        expect(response.body.regras[0].descricao).to.equal(project.description0)
        expect(response.body.regras[0].regra_aprovada).to.equal(true)
...
describe('numero total de parcelas REPROVADO', () => {
  ...
  it('successfully', () => {
    ...
    cy.numero_total_parcelas_reprovado_pine_inss_corban()
      .then(response => {
        expect(response.status).to.equal(201)
        expect(response.body.regras[0].descricao).to.equal(project.description0)
        expect(response.body.regras[0].regra_aprovada).to.equal(true)
...
describe('Data de emissão do RG REPROVADO', () => {
  ...
  it('successfully', () => {
    ...
    cy.data_emissao_rg_reprovado_pine_inss_corban()
      .then(response => {
        expect(response.status).to.equal(201)
        expect(response.body.regras[0].descricao).to.equal(project.description0)
        expect(response.body.regras[0].regra_aprovada).to.equal(true)
...
describe('idade maxima REPROVADO', () => {
  ...
  it('successfully', () => {
    ...
    cy.idade_maxima_reprovado_pine_inss_corban()
      .then(response => {
        expect(response.status).to.equal(201)
        expect(response.body.regras[0].descricao).to.equal(project.description0)
        expect(response.body.regras[0].regra_aprovada).to.equal(true)
...
describe('idade minima REPROVADO', () => {
  ...
  it('successfully', () => {
    ...
    cy.idade_minima_reprovado_pine_inss_corban()
      .then(response => {
        expect(response.status).to.equal(201)
        expect(response.body.regras[0].descricao).to.equal(project.description0)
        expect(response.body.regras[0].regra_aprovada).to.equal(true)
...
describe('Valor mínimo contrato REPROVADO', () => {
  ...
  it('successfully', () => {
    ...
    cy.valor_minimo_contrato_reprovado_pine_inss_corban()
      .then(response => {
        expect(response.status).to.equal(201)
        expect(response.body.regras[0].descricao).to.equal(project.description0)
        expect(response.body.regras[0].regra_aprovada).to.equal(true)
