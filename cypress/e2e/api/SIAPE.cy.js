  ...
  it('successfully', () => {
    cy.analise_com_sucesso_siape()
      .then(response => {
        ...
        expect(regras.regra_aprovada).to.be.true
        regras = response.body.regras.find(m => m.descricao === "Taxa Maxima: 2.05;")
        expect(regras.regra_aprovada).to.be.true
        regras = response.body.regras.find(m => m.descricao === "Valor Minimo Contrato: R$ 700.00;")
        expect(regras.regra_aprovada).to.be.true
        ...
        expect(regras.regra_aprovada).to.be.true
        regras = response.body.regras.find(m => m.descricao === "Codigo UPAG;")
        expect(regras.regra_aprovada).to.be.true
        regras = response.body.regras.find(m => m.descricao === "Codigo Orgao;")
        expect(regras.regra_aprovada).to.be.true
      })
  })
})
...
describe('Idade Minima: 21 anos; REPROVADO', () => {
  it('successfully', () => {
    cy.idade_minima_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Idade Maxima: 73 anos; REPROVADO', () => {
  it('successfully', () => {
    cy.idade_maxima_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Parcela Minima; REPROVADO', () => {
  it('successfully', () => {
    cy.parcela_minima_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Taxa Minima: 1.20; REPROVADO', () => {
  it('successfully', () => {
    cy.taxa_minima_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Taxa Maxima: 2.05; REPROVADO', () => {
  it('successfully', () => {
    cy.taxa_maxima_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
        let regraEncontrada = response.body.regras.find(m => m.descricao === "Taxa Maxima: 2.05;");
        expect(regraEncontrada.regra_aprovada).to.be.false;
      })
  })
})

describe('Valor Minimo Contrato: R$ 700.00; REPROVADO', () => {
  it('successfully', () => {
    cy.valor_minimo_contrato_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
        let regraEncontrada = response.body.regras.find(m => m.descricao === "Valor Minimo Contrato: R$ 700.00;");
        expect(regraEncontrada.regra_aprovada).to.be.false;
      })
  })
})
...
describe('Valor Maximo Contrato: R$ 20000.00 REPROVADO', () => {
  it('successfully', () => {
    cy.valor_maximo_contrato_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Data de emissao do documento x Data de nascimento; REPROVADO', () => {
  it('successfully', () => {
    cy.data_emissao_documento_x_data_nascimento_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Contrato Liquidado; REPROVADO', () => {
  it('successfully', () => {
    cy.contrato_liquidado_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Inadimplência Parcela/Contrato; REPROVADO', () => {
  it('successfully', () => {
    cy.inadimplencia_parcela_contrato_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Numero Total de Parcelas; REPROVADO', () => {
  it('successfully', () => {
    cy.numero_total_parcelas_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Numero Maximo Parcelas: 12; REPROVADO', () => {
  it('successfully', () => {
    cy.numero_maximo_parcelas_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Numero Minimo Parcelas: 10; REPROVADO', () => {
  it('successfully', () => {
    cy.numero_minimo_parcelas_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Range data vencimento; REPROVADO', () => {
  it('successfully', () => {
    cy.range_data_vencimento_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Validacao Bureau - Obito, PEP; REPROVADO', () => {
  it('successfully', () => {
    cy.validacao_bureau_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Situacao CPF Receita: Diferente de Regular; REPROVADO', () => {
  it('successfully', () => {
    cy.situacao_cpf_receita_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
...
describe('Codigo UPAG; REPROVADO', () => {
  it('successfully', () => {
    cy.codigo_upag_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
        let regraEncontrada = response.body.regras.find(m => m.descricao === "Codigo UPAG;");
        expect(regraEncontrada.regra_aprovada).to.be.false;
      })
  })
})

describe('Codigo Orgao; REPROVADO', () => {
  it('successfully', () => {
    cy.codigo_orgao_reprovado_siape()
      .then(response => {
        expect(response.status).to.equal(201)
        let regraEncontrada = response.body.regras.find(m => m.descricao === "Codigo Orgao;");
        expect(regraEncontrada.regra_aprovada).to.be.false;
      })
  })
})
